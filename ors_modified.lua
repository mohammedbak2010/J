...
-- ============================================================
-- TP DOWN BUTTON (مع زر جانبي لإخفاء/إظهار)
-- ============================================================
do
    ...
    tpGui.DisplayOrder = 10

    -- ======= الزر الجانبي (toggle) =======
    local sideBtn = Instance.new("TextButton")
    sideBtn.Parent          = tpGui
    sideBtn.Size            = UDim2.new(0, 22, 0, 70)
    sideBtn.Position        = UDim2.new(0, 0, 0.62, 0)
    sideBtn.Text            = "▶"
    sideBtn.Font            = Enum.Font.GothamBold
    sideBtn.TextSize        = 13
    sideBtn.TextColor3      = Color3.fromRGB(255, 255, 255)
    sideBtn.BackgroundColor3 = Color3.fromRGB(180, 0, 0)
    ...
    do
        ...
        sc.Parent = sideBtn
        local ss = Instance.new("UIStroke", sideBtn)
        ss.Thickness = 1.5
        ss.Color = Color3.fromRGB(255, 80, 80)
    end

    -- ======= الزر الرئيسي Tp Down =======
    local mainBtn = Instance.new("TextButton")
    mainBtn.Parent          = tpGui
    mainBtn.Size            = UDim2.new(0, 110, 0, 44)
    mainBtn.Position        = UDim2.new(0, 26, 0.62, 0)
    mainBtn.Text            = "⬇  Tp Down"
    ...
    do
        ...
        local mg = Instance.new("UIGradient", mainBtn)
    ...
    sideBtn.MouseButton1Click:Connect(function()
        ...
        mainBtn.Visible = btnVisible
        sideBtn.Text = btnVisible and "◀" or "▶"
    end)
    sideBtn.Text = "◀"
    ...
    UIS2.InputChanged:Connect(function(input)
        if dragging and input == dragInput2 then
            ...
            -- حرك الزر الجانبي معه
            sideBtn.Position = UDim2.new(
                newPos.X.Scale, newPos.X.Offset - 24,
                newPos.Y.Scale, newPos.Y.Offset + (44 - 70) / 2
            )
        end
    end)
