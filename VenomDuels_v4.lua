...
local GLOBAL_CONFIG_FILE = "VenomDuel_Config.json"
local _globalConfig = {}
...
pcall(function()
    if CoreGui:FindFirstChild("VenomDuel_v4") then
        CoreGui:FindFirstChild("VenomDuel_v4"):Destroy()
    end
end);
...
hStroke.Thickness    = 2
hStroke.Color        = Color3.fromRGB(30, 120, 255)
...
local hubTitleLbl = New("TextLabel", {
    Text = "VENOM DUELS", TextColor3 = Color3.fromRGB(255, 255, 255),
...
do
    ...
    _tcStroke.Color = Color3.fromRGB(30, 120, 255)
...
local function Toggle(page, label, default, cb)
    ...
    do
        ...
        _rs.Thickness = 1.2
        _rs.Color = Color3.fromRGB(30, 120, 255)
        _rs.Transparency = 0
    ...
    local bg = New("Frame", {
        ...
        BackgroundColor3=on and Color3.fromRGB(30,120,255) or C.TogOff, ZIndex=8, Parent=row,
    })
    ...
    New("TextButton", {
        ...
        on = not on
        TweenService:Create(bg,  TweenInfo.new(0.18), {BackgroundColor3=on and Color3.fromRGB(30,120,255) or C.TogOff}):Play()
